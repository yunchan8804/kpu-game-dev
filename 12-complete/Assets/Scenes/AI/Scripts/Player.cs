namespace Scenes.AI
{
    ...
    public class Player : MonoBehaviour, IDamagable
    {
        ...
        private void Start()
        {
            ...
            foreach (var skill in skillDatabase.PlayerSkills)
            {
                EventManager.On($"skill_active_{skill.skillName}", SkillActive);
            }
        }

        private void SkillActive(object obj)
        {
            print(obj);
            skillDatabase.PlayerSkills.FirstOrDefault(_ => _.skillName == (string)obj)?.Activate();
        }
